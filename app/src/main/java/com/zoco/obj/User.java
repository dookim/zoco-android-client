...
public class User {
    ...
    /**
     * @param nickname in order to check whether client is registered or not
     */
    ...
    /**
     * @param nickname in order to login, if client login succeed, client will receive "user object"
     ...
     * @param provider
     * @param univ
     * @param password in order to register user to server, client should send this information below
